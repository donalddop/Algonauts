function generate_feats_alexnet(image_dir,save_dir)
% generates alexnet activations of the selected layers
% Inputs:
...
% path to save the downloaded alexnet weights
modelPath = 'data/models/imagenet-caffe-alex.mat' ;
...
select_layers_list = ["conv1","conv2","conv3","conv4", "conv5", "fc6", "fc7", "fc8"];
...
for ii=1:nfiles
    ...
    conv1 = net.vars(layer_index(1)).value;
    conv2 = net.vars(layer_index(2)).value;
    conv3 = net.vars(layer_index(3)).value;
    conv4 = net.vars(layer_index(4)).value;
    conv5 = net.vars(layer_index(5)).value;
    fc6 = net.vars(layer_index(6)).value;
    fc7 = net.vars(layer_index(7)).value;
    fc8 = net.vars(layer_index(8)).value;
    save(save_file_path,"conv1","conv2","conv3","conv4", "conv5", "fc6", "fc7", "fc8")
end
